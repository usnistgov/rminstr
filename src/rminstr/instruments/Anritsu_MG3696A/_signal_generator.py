"""Anritsu MG3696A signal generator."""
...
class SignalGenerator(Instrument, ABC_SignalGenerator):
    """Implementation of the Anritsu MG3696A as a signal generator."""
    ...
    def __init__(
        ...
        self.info_dict['model_number'] = 'Anritsu_MG3696A'
    ...
    def setup(
        ...
        **kwargs,
        ...
        Note, the MG3696A can have amplitude modulation, but our unit
        does not have that option installed.
        ...
        if f_GHz is not None:
            self.write('CF0 {} GH ACW'.format(f_GHz))
    ...
    def get_frequency(self):
        ...
        return float(self.query('OF0')) * 1e-3
